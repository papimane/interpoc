...
class SocieteType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('forme_juridique')
            ->add('numeroAdr', TextType::class, array('required' => true,'label' => 'Numéro','attr' => ['html5' => false,],))
            ->add('typeVoieAdr', TextType::class, array('required' => true,'label' => 'Type de voie','attr' => ['html5' => false,],))
            ->add('nomVoieAdr', TextType::class, array('required' => true,'label' => 'Nom de voie','attr' => ['html5' => false,],))
            ->add('villeAdr', TextType::class, array('required' => true,'label' => 'Ville','attr' => ['html5' => false,],))
            ->add('cpAdr', TextType::class, array('required' => true,'label' => 'Code postal','attr' => ['html5' => false,],))
        ;
    }
